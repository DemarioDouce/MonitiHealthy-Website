...
const NurseAddVitalSignPage = (props) => {
  const { userName, fullName } = (props.location && props.location.state) || {};
    ...
    <div>
      <Container>
        <div className="text-center">
          ...
          >
            <h3>Add new vital sign for {fullName}</h3>
            {/* pulseRate */}
...
export default NurseAddVitalSignPage;
